(function(){
  ...
  #ef-chat-header {
    background: var(--ef-header-color, #162a4a);
  ...
  #ef-input:focus { border-color:var(--ef-header-color, #162a4a); }
  #ef-send-btn { width:38px; height:38px; border-radius:50%; background:var(--ef-header-color, #162a4a); border:none; cursor:pointer; display:flex; align-items:center; justify-content:center; flex-shrink:0; transition:opacity 0.2s; }
